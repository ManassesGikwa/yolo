provider "google" {
  credentials = file("/home/manasses/Downloads/sapient-forest-440108-r1-4a810786bbba.json") # Replace with your service account key path
...
resource "google_compute_instance" "app_server" {
  ...
  metadata = {
    ssh-keys = "manassesgikwa:${file("/home/manasses/.ssh/new_key.pub")}"  # Add your SSH key here
  }
  ...
  provisioner "remote-exec" {
    ...
    connection {
      type        = "ssh"
      user        = "manassesgikwa"
      private_key = file("/home/manasses/.ssh/new_key") # Replace with your private key path
